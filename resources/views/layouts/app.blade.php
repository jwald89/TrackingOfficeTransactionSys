    ...
    <!-- end page title -->
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Raqwelson.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Design & Develop by NoviceCoder
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from skote-v-light.codeigniter.themesbrand.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Sep 2021 16:00:44 GMT -->
</html>
